# Cloudder - Cloudinary wrapper for Laravel 7 / Lumen

[![Build Status](http://img.shields.io/travis/jrm2k6/cloudder/master.svg?style=flat-square)](https://travis-ci.org/el3zahaby/cloudder)
[![License](http://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](http://www.opensource.org/licenses/MIT)
[![Latest Version](http://img.shields.io/packagist/v/el3zahaby/cloudder.svg?style=flat-square)](https://packagist.org/packages/el3zahaby/cloudder)
[![Total Downloads](https://img.shields.io/packagist/dt/el3zahaby/cloudder.svg?style=flat-square)](https://packagist.org/packagesel3zahaby/cloudder)

> Initially forked from https://github.com/jrm2k6/cloudder.
...
You can find a working example in the repo [cloudder-l5-example](https://github.com/el3zahaby/cloudder-l5-sample-project)
